...
var
  AppDetailFormC: TAppDetailFormC;
...
procedure TAppDetailFormC.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action := TCloseAction.caFree;
end;

procedure TAppDetailFormC.FormKeyUp(Sender: TObject; var Key: Word; var KeyChar: Char; Shift: TShiftState);
begin
  if Key = 137 then
    Self.Free;
end;

procedure TAppDetailFormC.Button1Click(Sender: TObject);
begin
  // MemoCancelBody.Text
end;

procedure TAppDetailFormC.ButtonApproveClick(Sender: TObject);
begin
...
procedure TAppDetailFormC.ButtonBackClick(Sender: TObject);
begin
  Self.Close;
end;

procedure TAppDetailFormC.ButtonCancelClick(Sender: TObject);
begin
  RectangleChoose.Visible := false;
end;

procedure TAppDetailFormC.HeaderFrame1ButtonBackClick(Sender: TObject);
begin
  Self.Close;
end;
...
procedure TAppDetailFormC.ListViewAmzomveliPullRefresh(Sender: TObject);
begin
...
procedure TAppDetailFormC.ListViewAmzomveliUpdateObjects(const Sender: TObject; const AItem: TListViewItem);
begin
...
procedure TAppDetailFormC.ListViewAppDetailsPullRefresh(Sender: TObject);
begin
  Self.ListViewOffers.PullRefreshWait := True;
  Self.ListViewAppDetails.PullRefreshWait := True;
  Self.ListViewProperties.PullRefreshWait := True;
...
procedure TAppDetailFormC.ListViewOffersItemClick(const Sender: TObject; const AItem: TListViewItem);
begin
...
procedure TAppDetailFormC.ListViewOffersPullRefresh(Sender: TObject);
begin
  Self.ListViewOffers.PullRefreshWait := True;
  Self.ListViewAppDetails.PullRefreshWait := True;
  Self.ListViewProperties.PullRefreshWait := True;
...
procedure TAppDetailFormC.ListViewOffersUpdateObjects(const Sender: TObject; const AItem: TListViewItem);
begin
...
procedure TAppDetailFormC.ListViewPropertiesPullRefresh(Sender: TObject);
begin
  Self.ListViewOffers.PullRefreshWait := True;
  Self.ListViewAppDetails.PullRefreshWait := True;
  Self.ListViewProperties.PullRefreshWait := True;
