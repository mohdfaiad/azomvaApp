...
uses
  System.UITypes, System.SysUtils, FMX.Dialogs, FMX.Platform, FMX.Forms,
  FMX.Graphics
{$IF defined(ANDROID)}
    , Androidapi.JNIBridge, Androidapi.Helpers, Androidapi.JNI.OS,
  Androidapi.JNI.JavaTypes, Androidapi.JNI, Androidapi.JNI.App
{$ELSEIF defined(IOS)}
    , FMX.Helpers.iOS, FMX.Platform.iOS, iOSapi.UIKit, iOSapi.Foundation,
  iOSapi.CoreGraphics, iOSapi.CoreImage
{$ENDIF};
